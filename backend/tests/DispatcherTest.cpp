...
TEST_CASE("session-set") {
  tt::rpc::Dispatcher dispatcher{nullptr};
  auto response =
      dispatcher.dispatch(R"({"method":"session-set","arguments":{"download-dir":"."}})").get();
  ResponseView view{response};
...
TEST_CASE("session-test") {
  tt::rpc::Dispatcher dispatcher{nullptr};
  auto response =
      dispatcher.dispatch(R"({"method":"session-test","arguments":{}})").get();
  ResponseView view{response};
...
TEST_CASE("tt-get-capabilities reports features") {
  tt::rpc::Dispatcher dispatcher{nullptr};
  auto response =
      dispatcher.dispatch(R"({"method":"tt-get-capabilities","arguments":{}})").get();
  ResponseView view{response};
...
TEST_CASE("session-stats") {
  tt::rpc::Dispatcher dispatcher{nullptr};
  auto response =
      dispatcher.dispatch(R"({"method":"session-stats","arguments":{}})").get();
  ResponseView view{response};
...
TEST_CASE("session-close") {
  tt::rpc::Dispatcher dispatcher{nullptr};
  auto response =
      dispatcher.dispatch(R"({"method":"session-close","arguments":{}})").get();
  ResponseView view{response};
...
TEST_CASE("free-space success") {
  tt::rpc::Dispatcher dispatcher{nullptr};
  auto response =
      dispatcher.dispatch(R"({"method":"free-space","arguments":{"path":"."}})").get();
  ResponseView view{response};
...
TEST_CASE("torrent-start missing ids") {
  tt::rpc::Dispatcher dispatcher{nullptr};
  auto response =
      dispatcher.dispatch(R"({"method":"torrent-start","arguments":{}})").get();
  ResponseView view{response};
...
TEST_CASE("torrent-remove missing ids") {
  tt::rpc::Dispatcher dispatcher{nullptr};
  auto response =
      dispatcher.dispatch(R"({"method":"torrent-remove","arguments":{}})").get();
  ResponseView view{response};
...
TEST_CASE("torrent-set engine unavailable") {
  tt::rpc::Dispatcher dispatcher{nullptr};
  auto response = dispatcher.dispatch(R"({"method":"torrent-set","arguments":{"ids":[1]}})").get();
  ResponseView view{response};
...
TEST_CASE("torrent-rename-path missing") {
  tt::rpc::Dispatcher dispatcher{nullptr};
  auto response =
      dispatcher.dispatch(R"({"method":"torrent-rename-path","arguments":{}})").get();
  ResponseView view{response};
...
TEST_CASE("group-set no-op") {
  tt::rpc::Dispatcher dispatcher{nullptr};
  auto response = dispatcher.dispatch(R"({"method":"group-set","arguments":{}})").get();
  ResponseView view{response};
...
TEST_CASE("blocklist-update engine unavailable") {
  tt::rpc::Dispatcher dispatcher{nullptr};
  auto response =
      dispatcher.dispatch(R"({"method":"blocklist-update","arguments":{}})").get();
  ResponseView view{response};
...
TEST_CASE("unsupported method") {
  tt::rpc::Dispatcher dispatcher{nullptr};
  auto response =
      dispatcher.dispatch(R"({"method":"does-not-exist","arguments":{}})").get();
  ResponseView view{response};
