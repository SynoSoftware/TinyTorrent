...
If you prefer a Visual Studio solution generated by Meson, use:

```
./make vs Debug
```

This runs Meson setup with the Visual Studio backend (`--backend=vs2022`) and generates a `.sln` under `build_vs/debug`.
